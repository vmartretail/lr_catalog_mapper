...
# Copy the default mapping to a mutable mapping variable
...
mapping_df.columns = ["LimeRoad Field", "myntra", "ajio", "flipkart"]

st.markdown("### Edit Mapping (if needed)")
